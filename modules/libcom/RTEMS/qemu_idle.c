...
{
    while(1) {
        /* A bit of a hack here as RTEMS doesn't properly manage HID0.
         ...
         *
         * Also, QEMU seemingly gets sleep entry a bit wrong.
         * As sleep conditions are only tested when MSR
         * is set, but not when HID0 is set (I think it should
         * be in both cases).  So we must write MSR each time _after_
         * setting HID0.
         */
